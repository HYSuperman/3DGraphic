...
// robots
// static RigTForm g_objectRbt[CUBE_NUMBER] = {RigTForm(Cvec3(-2,1,0)), 
//                                             RigTForm(Cvec3(2,1,0))};
...
static void keyboard(const unsigned char key, const int x, const int y) {
  ...
  case 'v':
    ...
    // in hw4, after changing the camera, object is always the camera
...
static void initScene() {
  ...
  // set current picked node to the same as groundNode
