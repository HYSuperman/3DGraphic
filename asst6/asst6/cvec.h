...
template<typename T, int n>
inline Cvec<T, n> interpolateCatmullRom(
                          const Cvec<T, n>& v0,
                          const Cvec<T, n>& v1,
                          const Cvec<T, n>& v2,
                          const Cvec<T, n>& v3, const T alpha){
  Cvec<T, n> f = lerp(v0, v1, alpha);
  Cvec<T, n> g = lerp(v1, v2, alpha);
  Cvec<T, n> h = lerp(v2, v3, alpha);
  Cvec<T, n> m = lerp(f, g, alpha);
  Cvec<T, n> nn = lerp(g, h, alpha);
  Cvec<T, n> ct = lerp(m, nn, alpha);
  return ct;
}

template<typename T, int n>
inline Cvec<T, n> computeControlValueD(const Cvec<T, n>& v0, const Cvec<T, n>& v1, const Cvec<T, n>& v2){
  return (v2 - v0)/6 + v1;
}

template<typename T, int n>
inline Cvec<T, n> computeControlValueE(const Cvec<T, n>& v1, const Cvec<T, n>& v2, const Cvec<T, n>& v3){
  return (v3 - v1)/(-6) + v2;
}
